...
from core.models import Applicant, BookmarkProject, Project, Product, Category, Farmer, Buyer,Expert, CartOrder, CartItems, ProjectCategory, Wishlist, Address, ProductReview, ProductImages, ContactUs, Coupon
